...
print("\nLista de aprendices:", aprendices)
...
print(f"\nEl aprendiz con mayor edad es: {aprendices[pos]} ({mayor} años)")


# 4. Insertar nombre de la instructora en posición 

instructora = input("\nIngrese el nombre de la instructora: ")
...
print(f"\nCantidad de aprendices con 18 años: {conteo_18}")


# 6. Agregar aprendiz “x” al final de la lista

aprendices.append("x")
print("\nLista con aprendiz 'x' agregado:", aprendices)


# 7. Borrar el nombre de la instructora

aprendices.remove(instructora)
print("\nLista después de borrar la instructora:", aprendices)
...
print("\nPrimeros 10 aprendices:", aprendices[:10])
=

# 10. Mostrar los 10 últimos aprendices

print("\nÚltimos 10 aprendices:", aprendices[-10:])


# 11. Mostrar del elemento 10 al 20

print("\nAprendices del 10 al 20:", aprendices[9:20])


# 12. Mostrar elementos cuyo índice sea PAR

print("\nElementos con índice PAR:")
